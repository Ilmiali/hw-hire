...
interface RecruitingAssignSelectorProps {
  currentApplication: RecruitingApplication;
  onAssign: (params: { groupId: string; memberId?: string }) => void;
}

export function RecruitingAssignSelector({ currentApplication, onAssign }: RecruitingAssignSelectorProps) {
