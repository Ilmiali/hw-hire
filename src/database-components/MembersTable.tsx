  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        ...
        <Button onClick={() => setIsAddDialogOpen(true)} type="button" color="dark/zinc"> 
          Add Members
        </Button>
      </div>
      {members.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-8 px-4 text-center">
          ...
          <p className="text-zinc-400 dark:text-zinc-500 text-xs mt-1">Click "Add Members" to invite team members</p>
        </div>
      ) : (
        <DataTable
          data={members}
